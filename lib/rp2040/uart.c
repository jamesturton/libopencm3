 ...
 *
 * @brief <b>RP2040 Universal Asynchronous Receiver/Transmitter (UART)</b>
 *
 * This library supports the UART in the RP2040.
 * Devices can have up to 2 UARTs.
 *
...
{
	uint32_t clock = clock_get_hz(CLOCKS_CLK_PERI);
 ...
 *
 * The UART on the RP2040 can either be used with a single character TX and RX
